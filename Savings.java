...
public class Savings extends Account implements AccountOperations
{
	private double bal;
	private static String accNo;
	
	public Savings( String name, long mobNo) 
	{
		super(name,mobNo);
		accNo=getAccNo();
	...
	public String getAccNo() {
		String s=getMobNo()+"";
		return "Savg@"+s.substring(0, 3)+"A"+s.substring(s.length()-5);
	}
